...
public static class WebApplicationExtensions
{
    ...
    private static List<Product> GetProducts(decimal? minimumUnitPrice = null)
    {
        ...
        builder.InitialCatalog = "Northwind"; builder.MultipleActiveResultSets = true; builder.Encrypt = true;
        builder.TrustServerCertificate = true; builder.ConnectTimeout = 10; // Default is 30 seconds. builder.DataSource = "."; // Local SQL Server builder.IntegratedSecurity = true;
